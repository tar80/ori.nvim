return function(opts, colors)
  return {
    ...
    DiagnosticVirtualTextError = { fg = colors.red, bg = colors.shade_red, style = opts.styles.virtualtext },
    DiagnosticVirtualTextWarn = { fg = colors.olive, bg = colors.shade_olive, style = opts.styles.virtualtext },
    DiagnosticVirtualTextInfo = { fg = colors.blue, bg = colors.shade_blue, style = opts.styles.virtualtext },
    DiagnosticVirtualTextHint = { fg = colors.purple, bg = colors.shade_purple, style = opts.styles.virtualtext },
    DiagnosticVirtualTextOk = { fg = colors.green, bg = colors.shade_green, style = opts.styles.virtualtext },
    DiagnosticVirtualLinesError = { fg = colors.low_red, style = opts.styles.virtualtext },
    DiagnosticVirtualLinesWarn = { fg = colors.low_olive, style = opts.styles.virtualtext },
    DiagnosticVirtualLinesInfo = { fg = colors.low_blue, style = opts.styles.virtualtext },
    DiagnosticVirtualLinesHint = { fg = colors.low_purple, style = opts.styles.virtualtext },
    DiagnosticVirtualLinesOk = { fg = colors.low_green, style = opts.styles.virtualtext },
    -- DiagnosticVirtLineinesError = {},
