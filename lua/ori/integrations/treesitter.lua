return function(opts, colors)
  return {
    ...
    ['@markup.heading.1'] = { fg = colors.fg, bg = colors.shade_cyan, style = 'bold' },
    ['@markup.heading.2'] = { fg = colors.fg, bg = colors.shade_green, style = 'bold' },
    ['@markup.heading.3'] = { fg = colors.fg, bg = colors.shade_olive, style = 'bold' },
    ['@markup.heading.4'] = { fg = colors.fg, bg = colors.shade_purple, style = 'bold' },
    ['@markup.heading.5'] = { fg = colors.fg, bg = colors.shade_purple, style = 'bold' },
    ['@markup.heading.6'] = { fg = colors.fg, bg = colors.shade_purple, style = 'bold' },
    ...
    ['@markup.raw'] = { fg = colors.fg, bg = colors.float },
    ['@markup.raw.block'] = { bg = colors.float },
    ['@markup.underline'] = { link = '@test.underline' },
    ...
    ['@text.underline'] = { fg = colors.fg, sp = colors.fg, style = 'underline' },
